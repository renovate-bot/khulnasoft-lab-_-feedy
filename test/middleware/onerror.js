...
describe('httperror', () => {
    it(`httperror`, async () => {
        ...
        expect(response.text).toMatch(
            /Response code 404 \(Not Found\): target website might be blocking our access, you can <a href="https:\/\/docs\.rsshub\.app\/install\/">host your own FEEDy instance<\/a> for a better usability\./
        );
    }, 20000);
});
