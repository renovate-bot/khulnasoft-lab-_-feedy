...
describe('config', () => {
    ...
    it('no random ua', () => {
        ...
        const config = require('../lib/config').value;
        expect(config.ua).toBe('FEEDy/1.0 (+http://github.com/khulnasoft-lab/feedy; like FeedFetcher-Google)');
    ...
    it('random ua', () => {
        const config = require('../lib/config').value;
        expect(config.ua).not.toBe('FEEDy/1.0 (+http://github.com/khulnasoft-lab/feedy; like FeedFetcher-Google)');
    });
