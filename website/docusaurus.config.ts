...
const config: Config = {
    ...
    projectName: 'FEEDy', // Usually your repo name.
    ...
    plugins: [
        [
            '@dipakparmar/docusaurus-plugin-umami',
            {
                ...
                analyticsDomain: 'umami.khulnasoft-lab.dev', // Required
        ...
        [
            'classic',
            {
                docs: {
                    ...
                    editUrl: 'https://github.com/khulnasoft-lab/feedy/blob/master/website/',
    ...
    themeConfig: {
        ...
        navbar: {
            ...
            items: [
                ...
                {
                    href: 'https://github.com/khulnasoft-lab/feedy',
                    position: 'right',
        ...
        footer: {
            ...
            links: [
                ...
                },
                {
                    ...
                    items: [
                        {
                            label: 'About khulnasoft-lab',
                            to: 'https://khulnasoft-lab.cc',
                        },
                        {
                            label: 'FEEDy Radar - Discover and subscribe to RSS quickly',
                            href: 'https://github.com/khulnasoft-lab/feedy-Radar',
                        },
                        {
            ...
            copyright: `Copyright © ${new Date().getFullYear()} FEEDy.`,
        },
        prism: {
