...
<Route author="khulnasoft-lab" example="/dcard/posts/popular" path="/dcard/posts/:type?" paramsDesc={['排序，popular 熱門；latest 最新，默認為 latest']} radar="1" anticrawler="1" puppeteer="1" />
...
<Route author="EthanWng97 khulnasoft-lab nczitzk" example="/1point3acres/thread/hot" path="/1point3acres/thread/:type?/:order?" paramsDesc={['帖子分类, 见下表，默认为 hot，即热门帖子', '排序方式，见下表，默认为空，即最新回复']}>
  分类
