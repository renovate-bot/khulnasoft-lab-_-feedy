...
<Route author="khulnasoft-lab" example="/chouti/top/24" path="/chouti/top/:hour?" paramsDesc={['排行榜周期，可选 24 72 168 三种，默认 24']} />
...
<Route author="LogicJake Rongronggg9" example="/wechat/tgchannel/lifeweek" path="/wechat/tgchannel/:id/:mpName?/:searchQueryType?" paramsDesc={['公众号绑定频道 id', '欲筛选的公众号全名（URL-encoded，精确匹配），在频道订阅了多个公众号时可选用', '搜索查询类型，见下表']}>
  ...
  :::warning
  该方法需要通过 efb 进行频道绑定，具体操作见 [https://github.com/khulnasoft-lab/feedy/issues/2172](https://github.com/khulnasoft-lab/feedy/issues/2172)
  :::
</Route>
