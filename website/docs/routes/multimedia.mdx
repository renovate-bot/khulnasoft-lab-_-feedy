...
<Route author="khulnasoft-lab junfengP nczitzk" example="/javlibrary/star/abbds/en" path="/javlibrary/star/:id/:language?/:mode?" paramsDesc={['Star id, can be found in URL', 'Language, see below, Japanese by default, as `ja`', 'Mode, see below, videos with comments (by date) by default, as `1`']} radar="1" anticrawler="1">
  | videos with comments (by date) | everything (by date) |
  | ------------------------------ | -------------------- |
  | 1                              | 2                    |
...
<Route author="khulnasoft-lab" example="/163/music/playlist/35798529" path="/163/music/playlist/:id" paramsDesc={['歌单 id, 可在歌单页 URL 中找到']} radar="1" anticrawler="1" />

### 用户歌单 {#wang-yi-yun-yin-yue-yong-hu-ge-dan}

<Route author="khulnasoft-lab" example="/163/music/user/playlist/45441555" path="/163/music/user/playlist/:uid" paramsDesc={['用户 uid, 可在用户主页 URL 中找到']} radar="1" />
