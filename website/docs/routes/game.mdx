...
<Route author="khulnasoft-lab" example="/ps/list/STORE-MSF86012-PLUS_FTT_CONTENT" path="/ps/list/:gridName" paramsDesc={['gridName from the list']} notOperational="1">
...
<Route author="khulnasoft-lab" example="/ps/trophy/khulnasoft-lab_" path="/ps/trophy/:id" paramsDesc={['User ID']} radar="1" anticrawler="1" />
...
:::warning
Due to the regional restrictions, an FEEDy deployment in China Mainland may not work on accessing the TapTap International Website.
:::
...
<Route author="khulnasoft-lab" example="/mhw/update" path="/mhw/update" radar="1" />

### 最新消息 {#guai-wu-lie-ren-shi-jie-zui-xin-xiao-xi}

<Route author="khulnasoft-lab" example="/mhw/news" path="/mhw/news" radar="1" />
...
<Route author="khulnasoft-lab" example="/vgtime/keyword/怪物猎人" path="/vgtime/keyword/:keyword" radar="1" />
