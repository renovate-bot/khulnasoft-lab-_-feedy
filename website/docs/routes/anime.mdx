...
<Route author="khulnasoft-lab" path="/hpoi/items/all/:order?" example="/hpoi/items/all" paramsDesc={['排序, 见下表，默认为 add']}>
...
<Route author="khulnasoft-lab" path="/hpoi/items/character/:id/:order?" example="/hpoi/items/character/1035374" paramsDesc={['角色 ID', '排序, 见下表，默认为 add']}>
  | 发售    | 入库 | 总热度 | 一周热度 | 一天热度 | 评价   |
  | ------- | ---- | ------ | -------- | -------- | ------ |
  | release | add  | hits   | hits7Day | hitsDay  | rating |
</Route>
...
<Route author="khulnasoft-lab" path="/hpoi/items/work/:id/:order?" example="/hpoi/items/work/4117491" paramsDesc={['作品 ID', '排序, 见下表，默认为 add']}>
  | 发售    | 入库 | 总热度 | 一周热度 | 一天热度 | 评价   |
  | ------- | ---- | ------ | -------- | -------- | ------ |
  | release | add  | hits   | hits7Day | hitsDay  | rating |
</Route>
...
<Route author="khulnasoft-lab luyuhuang" path="/hpoi/user/:user_id/:caty" example="/hpoi/user/116297/buy" paramsDesc={['用户ID', '类别, 见下表']}>
  | 想买 | 预定     | 已入 | 关注 | 有过   |
  | ---- | -------- | ---- | ---- | ------ |
...
<Route author="khulnasoft-lab" path="/hpoi/bannerItem" example="/hpoi/bannerItem" />
