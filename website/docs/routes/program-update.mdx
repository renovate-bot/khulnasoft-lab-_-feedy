...
<Route author="khulnasoft-lab" example="/chrome/webstore/extensions/kefjpfngnndepjbopdmoebkipbgkggaa" path="/chrome/webstore/extensions/:id" paramsDesc={['Extension id, can be found in extension url']} />

## Civitai {#civitai}

### Latest models {#civitai-latest-models}

<Route author="khulnasoft-lab" example="/civitai/models" path="/civitai/models" />
...
<Route author="khulnasoft-lab" example="/civitai/discussions/4384" path="/civitai/discussions/:modelId" configRequired="1" />
...
<Route author="khulnasoft-lab" example="/firefox/addons/rsshub-radar" path="/firefox/addons/:id" paramsDesc={['Add-ons id, can be found in add-ons url']} />
...
<Route author="khulnasoft-lab" example="/openwrt/releases/xiaomi/xiaomi_redmi_router_ac2100" path="/releases/:brand/:model" paramsDesc={['Device Model, can be found in url of `Table of Hardware` -> `Device Page`', 'Same as above']} />
...
<Route author="khulnasoft-lab" path="/rsshub/routes/:lang?" example="/rsshub/routes/en" paramsDesc={['Language, `zh` means Chinese docs, other values or null means English docs, `en` by default']} />
...
<Route author="khulnasoft-lab" example="/xclient/app/sketch" path="/xclient/app/:name" paramsDesc={['应用名, 可在应用页 URL 中找到']} />
