...
<Route author="fengkx" path="/hexo/next/:url" example="/hexo/next/archive.khulnasoft-lab.me" paramsDesc={['the blog URL without the protocol (http:// and https://)']} configRequired="1" />
