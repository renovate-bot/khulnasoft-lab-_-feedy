...
<Route author="khulnasoft-lab" example="/hotukdeals/hot" path="/hotukdeals/:type" paramsDesc={['should be one of highlights, hot, new, discussed']} anticrawler="1" />

### hottest {#hotukdeals-hottest}

<Route author="khulnasoft-lab" example="/hotukdeals/hottest" path="/hotukdeals/hottest" anticrawler="1" />
...
<Route author="khulnasoft-lab" example="/uniqlo/new/sg/men" path="/uniqlo/new/:country/:category" paramsDesc={['currently only supports sg, us, jp', 'supports `men` `women`, `kids`, `baby`']} radar="1" />
...
<Route author="khulnasoft-lab" example="/smzdm/keyword/女装" path="/smzdm/keyword/:keyword" paramsDesc={['你想订阅的关键词']} radar="1" />

### 排行榜 {#shen-me-zhi-de-mai-pai-hang-bang}

<Route author="khulnasoft-lab" example="/smzdm/ranking/pinlei/11/3" path="/smzdm/ranking/:rank_type/:rank_id/:hour" paramsDesc={['榜单类型','榜单ID','时间跨度']} radar="1">
  -   榜单类型
...
<Route author="khulnasoft-lab" example="/mi/crowdfunding" path="/mi/crowdfunding" />
...
<Route author="xyqfer khulnasoft-lab bigfei" example="/xiaomiyoupin/latest" path="/xiaomiyoupin/latest" />
