...
The above code snippet from [Create Your Own FEEDy Route](/joinus/new-rss/start-code#better-reading-experience) shows how to use the cache to get the full text of the first comment of each issue. `ctx.cache.tryGet()` is used to determine if the data is already available within the cache. If it's not, the code retrieves the data and stores it in the cache.
...
[lib/middleware/cache/index.js](https://github.com/khulnasoft-lab/feedy/blob/master/lib/middleware/cache/index.js#L58)
