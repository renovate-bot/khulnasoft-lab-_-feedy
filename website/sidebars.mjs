    ...
    guideSidebar: [
        ...
        },
        {
            ...
            link: {
                ...
                slug: '/routes',
                description: 'Routes are the access paths of FEEDy. Each route contains a FEEDy rule, which tells FEEDy how to extract content from the website and generate RSS subscription.',
            },
            items: [
                {
                    type: 'doc',
