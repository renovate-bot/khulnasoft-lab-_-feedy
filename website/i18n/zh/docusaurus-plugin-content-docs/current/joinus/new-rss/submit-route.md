...
当您完成您的路由后，您可以提交一个 Pull Request（下称 PR）到 [FEEDy](https://github.com/khulnasoft-lab/feedy)。我们将使用 squash merge 策略，这意味着您分支中的所有提交将合并成 FEEDy 仓库上的一个提交。然而，保持您的提交历史干净整洁仍然很重要。我们还提供了一个直观的模板供您填写。
