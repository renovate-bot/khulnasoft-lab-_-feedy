/**
 * This function should be used by FEEDy middleware only.
...
const json = (data) => {
    const jsonFeed = {
        ...
        title: data.title || 'FEEDy',
        home_page_url: data.link || 'https://docs.rsshub.app',
        feed_url: data.feedLink,
        description: `${data.description || data.title} - Made with love by FEEDy(https://github.com/khulnasoft-lab/feedy)`,
        icon: data.image,
